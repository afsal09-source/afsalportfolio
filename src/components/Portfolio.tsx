  ...
  return <section id="portfolio" className="py-20 px-4">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          ...
          return <Card key={index} className="animate-fade-in shadow-elegant hover-scale group" style={{
            animationDelay: `${index * 0.1}s`
                ...
                <CardContent className="space-y-4">
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, techIndex) => <Badge key={techIndex} variant="secondary">
                        {tech}
                      </Badge>)}
                  </div>
                  <div className="space-y-1">
                    {project.highlights.map((highlight, highlightIndex) => <div key={highlightIndex} className="flex items-center gap-2 text-sm text-muted-foreground">
